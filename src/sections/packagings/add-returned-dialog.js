...
const AddReturned = ({ children, packagingDatas = [] , handlePost}) => {
  /**
   * * lOCAL STATE
   */
                ...
                <Popover>
                  <PopoverTrigger>
                    ...
                    >
                      ...
                      {date ? format(date, "PPP") : <span>Select returned date</span>}
                    </Button>
                  </PopoverTrigger>
...
AddReturned.propTypes = {
  children: PropTypes.node,
};
export default AddReturned;
